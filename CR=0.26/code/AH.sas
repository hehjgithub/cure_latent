...
%mend();
%macro estimate();
libname two 'E:\article\AH-cure-latent\simulation\code\5+t\temp result';
%do jj=1%to 1;
proc import out=two.Coxlatent&jj 
datafile="E:\article\AH-cure-latent\simulation\5+t\n=1000\data\Coxlatent&jj..csv" 
dbms=csv
replace;
run;
...
outfile="E:\article\AH-cure-latent\simulation\code\5+t\result\estall.csv"
dbms=csv
label
replace;
run;
...
outfile="E:\article\AH-cure-latent\simulation\code\5+t\result\hesall.csv"
dbms=csv
label
replace;
run;
